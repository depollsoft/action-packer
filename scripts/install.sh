...
echo -e "${BLUE}"
echo "╔═══════════════════════════════════════════════════════════╗"
echo "║             Action Packer Installation Script              ║"
echo "╚═══════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
setup_environment() {
    ...
    if [ -f "$ROOT_ENV_FILE" ]; then
        ...
        print_status "Using existing environment file at $BACKEND_ENV_FILE"
        print_info "Your existing configuration will be preserved."
        return
    fi
...
EOF
    print_status "Environment template created at $BACKEND_ENV_FILE"
    print_warning "Please edit $BACKEND_ENV_FILE to configure your GitHub App settings"
}
